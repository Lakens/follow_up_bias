...
#Plot effect sizes ----
png(file=paste("ESestimate_",toString(conditionselection),".png",sep=""),width=3600,height=2500, res = 300)
plot.new()
...
#plot sample sizes ----
png(file=paste("Nestimate_",toString(conditionselection),".png",sep=""),width=3600,height=2500, res = 300)
plot.new()
...
#Plot observed power----
png(file=paste("obspower_",toString(conditionselection),".png",sep=""),width=3600,height=2500, res = 300)
plot.new()
