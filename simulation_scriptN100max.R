...
simulateconditions <- 37:39 # change 1:nrconditions in the range you want to simulate on your machine; e.g. 11:25
for(cond in simulateconditions){ 
  ...
  saveRDS(nMAT,paste("n_",cond,"N100max.rds",sep=""))   # Save each simulation-condition to a separate file, for easy parallel simulation
  saveRDS(ESMAT,paste("ES_",cond,"N100max.rds",sep=""))
  saveRDS(pvalueMAT, paste("p_",cond,"N100max.rds",sep=""))
}
