...
tiff(file=paste("ESdistNPower.tiff",sep=""),width=2000,height=1000, units = "px", res = 300)
...
mtext(1,text="eta-squared",line=2) #drawsecond axis
par(new=T)
axis(1,lwd=2,line=3.5,at=seq(0.025,0.3,0.025),labels=n_power)
mtext(1,text="n (per group) for 80% power",line=5.5)
dev.off()